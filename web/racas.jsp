...
<html lang="pt-br">
    ...
    <body id="page-top">
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            ...
                                            <button id="btnAtualizarTabela" style="margin-bottom: 30px; background-color: #022700" onclick="atualizarRaca()" class="btn btn-primary btn-icon-split">
        ...
        <script type="text/javascript">
            ...
            function abrirEditarRaca(id, descricao) {
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form onsubmit="return editarRaca(this.id, this.descricao)" accept-charset="ISO-8859-1">
                            <div class="col-md-12">
        ...
        <div class="modal fade" id="modalCadastro" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form onsubmit="return cadastrarRaca(this.descricao)" accept-charset="ISO-8859-1">
                            <div class="col-md-12">
                                <label>Descrição:</label>
                                <input required="" autocomplete="off" class="form-control" type="text" id="descricao">
                            </div>
        ...
        <script src="js/manipular_racas.js?version=1"></script>

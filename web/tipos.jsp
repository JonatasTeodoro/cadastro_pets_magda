...
<html lang="pt-br">
    ...
    <body id="page-top">
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            ...
                                            <button id="btnAtualizarTabela" style="margin-bottom: 30px; background-color: #022700" onclick="atualizarTipo()" class="btn btn-primary btn-icon-split">
                                            ...
                                            <button  style="margin-bottom: 30px" onclick="$('#modalCadastro').modal('show');" class="btn btn-info btn-icon-split">
                                                <span class="icon text-white-50">
        ...
        <script type="text/javascript">
            ...
            function abrirEditarTipo(id, descricao) {
                var clique = confirm("Você deseja editar " + descricao + "?");
                if (clique == true) {
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form onsubmit="return editarTipo(this.id, this.descricao)" accept-charset="ISO-8859-1">
                            <div class="col-md-12">
                                <input type="hidden" id="id">
                                <label>Descrição:</label>
                                <input required="" autocomplete="off" class="form-control" type="text" id="descricao">
                            </div>
        ...
        <div class="modal fade" id="modalCadastro" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form onsubmit="return cadastrarTipo(this.descricao)" accept-charset="ISO-8859-1">
                            <div class="col-md-12">
                                <label>Descrição:</label>
                                <input required="" autocomplete="off" class="form-control" type="text" id="descricao">
                            </div>
        ...
        <script src="js/manipular_tipos.js?version=29"></script>
